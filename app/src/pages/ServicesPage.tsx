...
const services = [
  {
    ...
    features: ['Amount: ₹50K – ₹5Cr', 'Interest: 12% – 18%', 'Tenure: 1 – 5 Years','Tenure: 1 – 5 Years','Collateral: Not Required'],
  ...
  },
  {
    ...
    features: ['Interest: 10.49% – 24%', 'Amount: ₹50K – ₹50L', 'Tenure: 1 – 5 Years','Collateral: Not Required','Processing: 24 – 48 Hours'],
  ...
  },
  {
    ...
    features: ['Interest: 8.40% – 12%', 'Amount: ₹5L – ₹5Cr', 'Tenure: 5 – 30 Years','Tenure: 5 – 30 Years','Processing: 7 – 15 Days'],
  ...
  },
  {
    ...
    features: ['Interest: 9% – 14%', 'Amount: ₹1L – ₹1Cr', 'Tenure: 5 – 15 Years','Collateral: Based on Amount','Collateral: Based on Amount'],
  ...
  },
  {
    ...
    features: ['Interest: 11% – 17%', 'Amount: ₹10L – ₹10Cr', 'Tenure: 1 – 7 Years','Tenure: 1 – 7 Years','Processing: 5 – 15 Days'],
  ...
  },
  {
    ...
    features: ['Interest: 9.50% – 14%', 'Amount: ₹10L – ₹5Cr', 'Tenure: 5 – 15 Years','Collateral: Property','Processing: 10 – 20 Days'],
  ...
  },
  {
    ...
    features: ['Interest: 10% – 16%', 'Amount: ₹5L – ₹3Cr', 'Tenure: 3 – 10 Years','Collateral: Machinery','Processing: 5 – 12 Days'],
  ...
  },
  {
    ...
    features: ['Interest: 8.75% – 15%', 'Amount: ₹2L – ₹1Cr', 'Tenure: 1 – 7 Years','Collateral: Vehicle','Processing: 2 – 5 Days'],
  ...
  },
  {
    ...
    features: ['Interest: 11% – 18%', 'Amount: ₹20L – ₹10Cr', 'Tenure: 1 – 5 Years','Processing: 10 – 20 Days','Collateral: Property / Project'],
  ...
  },
  {
    ...
    features: ['Interest: 12% – 18%', 'Amount: ₹1L – ₹5Cr', 'Tenure: Flexible','Processing: 3 – 7 Days','Collateral: May Be Required'],
    color: 'from-emerald-500 to-emerald-600',
    bgColor: 'bg-emerald-50',
    iconColor: 'text-emerald-600',
  },
  {
    ...
    features: ['Interest: 13% – 20%', 'Amount: ₹5L – ₹3Cr', 'Tenure: Short Term','Collateral: Invoice Based','Processing: 2 – 7 Days'],
    color: 'from-violet-500 to-violet-600',
    bgColor: 'bg-violet-50',
    iconColor: 'text-violet-600',
  },
  {
    ...
    features: ['Interest: 10% – 15%', 'Amount: ₹50L – ₹20Cr', 'Tenure: 5 – 15 Years','Collateral: Institutional Property','Processing: 15 – 30 Days'],
